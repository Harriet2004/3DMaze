...
class PledgeMazeSolver(MazeSolver):
    ...
    def solveMaze(self, maze: Maze3D, entrance: Coordinates3D):
        ...
        while currCell not in maze.getExits():
            ...
            if ((currCell + self.directions[prefDirection]) in possibleNeighs):
            ...
            # Else there is a wall, perform wall following
                ...
                # While cannot move forward
                    ...
                    while (currCell + self.directions[prefDirection]) in possibleNeighs:
                        # Move in that direction
                        currCell = currCell + self.directions[prefDirection]
                        self.solverPathAppend(currCell)

                    while currCell not in maze.getExits() and turns != 0:
